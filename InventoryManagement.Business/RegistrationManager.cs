...
namespace InventoryManagement.Business
{
    public class RegistrationManager : IRegistrationManager
    {
        ...
        {
            return (objRegistrationRepo.GetParentParty(GroupId, StateCode));
        }
        ...
        {
            return (objRegistrationRepo.GetPendingPartyList());
        }
        ...
        {
            return (objRegistrationRepo.GetRegistartionGroupList());
        }
    }
}