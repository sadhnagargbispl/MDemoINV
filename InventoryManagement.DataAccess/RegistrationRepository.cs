...
namespace InventoryManagement.DataAccess
{
    public class RegistrationRepository : IRegistrationRepository
    {
        ...
        {
            return (objRegistrationAPI.GetParentParty(GroupId, StateCode));
        }
        ...
        {
            return (objRegistrationAPI.GetPendingPartyList());
        }
        ...
        {
            return (objRegistrationAPI.GetRegistartionGroupList());
        }
    }
}