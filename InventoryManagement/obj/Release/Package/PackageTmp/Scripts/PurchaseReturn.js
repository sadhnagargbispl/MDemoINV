...
var FromDate = "", ToDate = "";
var ProductCode = "0", CategoryCode = "0", SupplierCode = "0";
...
$(document).ready(function () {
    ...
    if (IsAdministrator == "True") {
        ...
        $("#SupplierCode").val(CurrentPartyCode);
    }
    GetAllCategory();
    GetAllProducts(0);
    ...
    $("#btnExport").on('click', function () {
        var UserTypeStr = "PurchaseReturnReport";
        var tableString = "";
        if (type == "detail") {
    ...
    $(".getReport").on('click', function () {
        ...
        if (DateError == false) {
            var InvoiceTypeVal = "";
            $.ajax({
                url: '/Report/GetPurchaseReturnReport',
                type: 'POST',
                data: { "FromDate": FromDate, "ToDate": ToDate, "SupplierCode": SupplierCode, "ProductCode": ProductCode, "CategoryCode": CategoryCode, "Type": type },
                async: false,
                dataType: "json",
    ...
    if (type == "detail") {
        grid = $('#grid').grid({
            ...
            columns: [
                ...
                { field: 'STRNO', title: 'STR.No.', width: 100, sortable: true, hidden: false, filterable: false },
                { field: 'STRDate', title: 'STR Date', width: 100, sortable: true, hidden: false, filterable: false },
                { field: 'ReturnBy', title: 'ReturnBy', width: 80, sortable: true, hidden: false, filterable: false },
                { field: 'ReturnByName', title: 'Name', width: 120, sortable: true, hidden: false, filterable: false },
                { field: 'ProductCode', title: 'Product Code', width: 80, sortable: true, hidden: false, filterable: false },
                { field: 'ProductName', title: 'Product Name', width: 150, sortable: true, hidden: false, filterable: false },
                ...
                { field: 'BillNo', title: 'Bill No', width: 80, sortable: true, hidden: false, filterable: false },
                { field: 'ReturnTo', title: 'Return To', width: 150, sortable: true, hidden: false, filterable: false }
            ],
        ...
        grid = $('#grid').grid({
            ...
            columns: [
                { field: 'SNo', title: 'S.No.', width: 80, sortable: true, hidden: false, filterable: false },
                { field: 'ReturnBy', title: 'ReturnBy', width: 100, sortable: true, hidden: false, filterable: false },
                { field: 'ProductCode', title: 'Product Code', width: 80, sortable: true, hidden: false, filterable: false },
                { field: 'ProductName', title: 'Product Name', width: 150, sortable: true, hidden: false, filterable: false },
                { field: 'Quantity', title: 'Quantity', width: 80, sortable: true, hidden: false, filterable: false },
                { field: 'Rate', title: 'Rate', width: 80, sortable: true, hidden: false, filterable: false },
    ...
    if (type == "Party") {
        for (var i = 0; i < FullPartyList.length; i++) {
            if (FullPartyList[i].PartyName == label) {
                $("#SupplierCode").val(FullPartyList[i].PartyCode);
                SupplierCode = FullPartyList[i].PartyCode;
                break;
            }
        }
    }
